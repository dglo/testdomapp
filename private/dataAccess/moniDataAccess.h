 ...
 * May, 2003
 * $Id: moniDataAccess.h,v 1.2 2003-05-30 01:22:58 mcp Exp $
 */
...
#define MAXMONI_DATA 512-4-MONI_TIME_LEN /* makes for 512-byte monitoring records */

#define MONI_TYPE_DOM_STATE_MSG 0xe1
...
void moniInsertDOMstateEvent(UBYTE *msg, long long *time, int len);     /* Type 1 - timestamped rec. of all
